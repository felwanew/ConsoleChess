...
namespace ConsoleChess
{
    class Bishop
    {
        public bool CheckIfMoveIsLegal(int [] MoveArray){
            ...
            if (Convert.ToInt32(MoveArray.GetValue(0)) == Convert.ToInt32(MoveArray.GetValue(2)) + 1 && Convert.ToInt32(MoveArray.GetValue(1)) == Convert.ToInt32(MoveArray.GetValue(3)) + 1 ||
